...
export default function Mihika() {
    ...
    >
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../public/mihika-profilepic.jpeg" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Mihika Sharma</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer science student at Purdue University, from New Delhi,
              India.
            </p>
          </div>
          <Link
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a
              href="https://www.linkedin.com/in/mihika0916/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/mihika0916"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/mihika_sharma_04/"
              target="_blank"
              rel="noreferrer"
            >
